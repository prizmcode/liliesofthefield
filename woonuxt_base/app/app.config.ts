...
export default defineAppConfig({
  ...
  shortDescription:
    'Creative studio specializing in brush calligraphy and original artwork. Combining traditional methods with organic beauty, we create mindful, intentional pieces designed to bring warmth and elevated artistry into the home.',
  description: `Creative studio specializing in brush calligraphy and original artwork.
From custom, hand-lettered commissions to watercolor portraits and original paintings, each item is designed and produced with meticulous care. Prints in various sizes also available.`,
